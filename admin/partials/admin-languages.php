...
if (isset($_POST['delice_language_settings_submit']) && check_admin_referer('delice_language_settings_nonce', 'delice_language_nonce_field')) {
    ...
    echo '<div class="notice notice-success is-dismissible"><p><strong>' . __('Language settings saved successfully!', 'delice-recipe-manager') . '</strong></p></div>';
}
...
<div class="wrap delice-settings-wrap">
    ...
    <form method="post" action="">
        <?php wp_nonce_field('delice_language_settings_nonce', 'delice_language_nonce_field'); ?>
        ...
        <div class="delice-card" style="margin-top:20px;">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <select name="selected_language" id="language-selector" class="regular-text">
                        ...
                        <p class="description"><?php _e('Choose the language for your recipe labels, then save settings', 'delice-recipe-manager'); ?></p>
                    </td>
                </tr>
            </table>
        </div>

...
// Plugin constants
define( 'DELICE_RECIPE_VERSION',    '4.1.0' );
define( 'DELICE_RECIPE_DB_VERSION', '2.2.0' ); // bump when schema changes require an upgrade routine
...
function delice_recipe_manager_init() {
    ...
    // v3.9.0 — Equipment section with AI extraction + affiliate matching
    require_once DELICE_RECIPE_PLUGIN_DIR . 'includes/class-delice-recipe-equipment.php';
